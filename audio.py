...
song = ["E","B","C","D","C","B","A","A","C","E","D","C","B","C","D","E","C","A","A","D","F","Ah","G","F","E","C","E","D","C","B","B","C","D","E","C","A","A"]
timing = [2] + [1,1,2] * 4 + [2,2,2] * 2 + [2,1,2] + [1,1,2] + [1,2] + [1,1,2] * 2 + [2,2,2,2]
...
notes = ['A','A#','B','C','C#','D','D#','E','F','F#','G','G#','Ah']
note_to_freq = {
        n: f
